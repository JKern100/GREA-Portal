...
export default function MailingListImportModal({ onClose }: Props) {
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={{ display: "grid", gap: 8 }}>
                ...
                >
                  ...
                  />
                  <div>
                    <div style={{ fontWeight: 600, fontSize: 13 }}>Comprehensive list (replace your office&apos;s entries)</div>
                    <div style={{ fontSize: 12, color: "var(--gray-600)" }}>
            ...
            {mode === "replace" && (
              ...
              >
                <label style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
                  ...
                  />
                  <span>
                    I understand that this will permanently delete every mailing-list entry currently sourced from my office before importing the uploaded file.
                  </span>
                </label>
              </div>
            )}
