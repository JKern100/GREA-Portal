...
export async function GET(request: Request) {
  ...
  if (format === "xlsx") {
    ...
    return new NextResponse(body as unknown as BodyInit, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="grea_pipeline_template.xlsx"`,
  ...
  return new NextResponse(csv, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="grea_pipeline_template.csv"`,
      "Cache-Control": "no-store"
    }
  });
}
